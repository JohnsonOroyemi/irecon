...
{ 
    ...
    if(mysqli_num_rows($result) > 0){
        ...
        if ($_SESSION["user_id"] == 1){ 
          echo "<script type='text/javascript'>alert('Admin successfully logged in!'); window.location.href = 'admin.php';</script>";
          exit;
        }
        
        else if ($_SESSION["user_id"] != 1){
          echo "<script type='text/javascript'>alert('You have successfully logged in!'); window.location.href = 'index.php';</script>";
        exit;
        }
        
        } else{
          echo "<script type='text/javascript'>alert('Failed!'); window.location.href = 'signin.php';</script>";
          exit;
...
<input type="password" name="password" class="form-control" placeholder="Your password" required="">
     <br><br>
    <input  class="btn" type="submit" name="login" value="Log in"> <br><br><br>
</div>
<a href="signup.php" class="newuser">New User? Sign Up</a>
</form>   
  </center>
